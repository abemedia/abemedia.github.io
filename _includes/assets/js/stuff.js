...
if ($(".img-link").length > 0) {
	$('.img-link').click(function () {
        $( "body" ).append( '<div id="imgModal" class="modal img-modal fade" tabindex="-1" role="dialog" aria-hidden="true"><div class="img"><span></span><br><img /></div><button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button></div>' );
